...
if python /u/project/tpresner/shared/qsub/practice/exercise4_client_tangai.py; then
    echo "Client script executed. Output saved to /u/project/tpresner/shared/qsub/practice/llm_test_$USER.txt"
else
